/*
 ...
 Source Schema         : interactive_classroom

 Target Server Type    : MySQL
 Target Server Version : 80036
 File Encoding         : 65001

 Date: 09/05/2024 23:25:07
*/
...
CREATE TABLE `approval_record`  (
  ...
  `leave_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '请假申请id',
  `approver_id` bigint(0) NOT NULL COMMENT '审批人id',
  `comment` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审批意见',
  `approval_time` datetime(0) NULL DEFAULT NULL COMMENT '审批时间',
  `status` bigint(0) NULL DEFAULT NULL COMMENT '待审批、已批准、已拒绝、已撤销、已转交、已过期等',
  `superior_id` bigint(0) NULL DEFAULT NULL COMMENT '上级审批人',
  `forward_id` bigint(0) NULL DEFAULT NULL COMMENT '转交审批人',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`, `approver_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1058 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '审批结果表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approver`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `approver_id` bigint(0) NULL DEFAULT NULL COMMENT '教师id',
  `approver_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '教师姓名',
  `role_id` bigint(0) NULL DEFAULT NULL COMMENT '角色id',
  `dept_id` bigint(0) NULL DEFAULT NULL COMMENT '学院id',
  `authority` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审批权限',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '审批人表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `checkin`  (
  ...
  `teacher_id` bigint(0) NULL DEFAULT NULL COMMENT '教师id',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `method` bigint(0) NULL DEFAULT NULL COMMENT '指定的签到方式',
  `source` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '签到指定数据',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '签到信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `checkin_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `checkin_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '签到来源',
  `student_id` bigint(0) NULL DEFAULT NULL COMMENT '学生id',
  `checkin_time` datetime(0) NULL DEFAULT NULL COMMENT '签到时间',
  `status` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '已签到、未签到、迟到字典',
  `location` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '签到地点',
  `remark` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '签到备注',
  `device` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '签到设备',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1115 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '签到明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `class_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '班级名称',
  `teacher_id` bigint(0) NULL DEFAULT NULL COMMENT '教师id',
  `dept_id` bigint(0) NULL DEFAULT NULL COMMENT '学院id',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  ...
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1024 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '班级表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '课程名',
  `description` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '课程描述',
  `type` int(0) NULL DEFAULT NULL COMMENT '必修课、选修课、实验课字典',
  `time` datetime(0) NULL DEFAULT NULL COMMENT '上课时间',
  `teacher_id` bigint(0) NOT NULL COMMENT '教师id',
  `capacity` int(0) NULL DEFAULT NULL COMMENT '授课学生数',
  `status` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '授课中、已结束、已取消字典',
  `tags` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '课程标签',
  `department` int(0) NOT NULL COMMENT '开课学院',
  `cover` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '课程封面',
  `credits` decimal(10, 2) NULL DEFAULT NULL COMMENT '课程学分',
  `period` int(0) NULL DEFAULT NULL COMMENT '授课课时',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`, `teacher_id`, `department`) USING BTREE,
  INDEX `index`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1002 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '课程表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course_record`  (
  ...
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1137 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '学生拥有的课程' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course_score`  (
  ...
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '学生课程成绩单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 139 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
CREATE TABLE `leave_application`  (
  ...
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `type` bigint(0) NULL DEFAULT NULL COMMENT '病假、事假、婚假、陪产假、丧假、调休假、其他等字典',
  `reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '理由',
  `apply_time` datetime(0) NULL DEFAULT NULL COMMENT '申请时间',
  `status` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '待审批、已批准、已驳回、已撤销、已转交、已过期等',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '学生请假信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notification`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `recipient_id` json NULL COMMENT '接收标识符',
  ...
  `type` int(0) NULL DEFAULT NULL COMMENT '系统通知、课堂通知、个人消息等字典',
  `send_time` datetime(0) NULL DEFAULT NULL COMMENT '发送时间',
  `priority` int(0) NULL DEFAULT NULL COMMENT '优先级',
  `source` int(0) NULL DEFAULT NULL COMMENT '系统自动生成、教师发布、学生提交等字典',
  `attachments` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '附件地址',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1034 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统通知' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notification_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `notification_id` bigint(0) NULL DEFAULT NULL COMMENT '消息id',
  ...
  `del_flag` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index`(`id`, `notification_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2438 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '通知已读表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 203 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '部门表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 133 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 107 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典类型表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1439 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2013 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2798 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `credit` decimal(10, 2) NULL DEFAULT NULL COMMENT '学分',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1007 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
